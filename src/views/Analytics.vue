      ...
      <div class="pages-content">
        <div class="pages-heading mg-b-20 d-flex align-items-center justify-content-between">
          <div class="heading-start d-flex align-items-center">
            <div class="pd-5 heading-icon rounded bg-dark-gray">
            ...
            <div class="pd-x-15">
              <h1 class="mg-b-10 d-flex align-items-center">متوسط حجم الأسرة <i
                  class="ri-question-line tx-18 tx-default tx-normal mg-x-5 op-6"></i></h1>
        ...
        <div class="quick-stats mg-b-15 card shadow rounded flex-wrap d-flex pd-y-20 pd-x-15">
          ...
          <div class="indicator-info">
            <h4 class="mg-b-10 d-flex align-items-center">بيانات المؤشر <i
